...
public:
	...
	VulkanGpu(const char *appname, HWND hWnd, HINSTANCE hInst, uint32_t width, uint32_t height, VkDeviceSize gpusize = 1024 * 1024 * 1024, void (*instance_cb)(VkInstance) = nullptr) {
		...
		{
			VkDeviceSize allocsize = gpusize;
