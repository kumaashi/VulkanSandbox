...
struct BufferImageCopy : VkBufferImageCopy {
	BufferImageCopy(uint32_t width, uint32_t height, uint32_t depth, uint32_t miplevel, VkDeviceSize offset) {
		memset(this, 0, sizeof(*this));
...
struct Pipeline {
	...
	enum {
		CONIFG_LINE_STRIP    = 0x00000001,
		CONIFG_LINE_LIST     = 0x00000002,
		CONIFG_BLEND_ADD     = 0x00010000,
		CONIFG_DEPTH_DISABLE = 0x01000000,
	};
